...
public class CommentController {
    ...
    public ResponseEntity writeComments(@PathVariable final int contentIdx, @RequestBody final Comment comment) {
        try{
            return new ResponseEntity(HttpStatus.OK);
        }catch (Exception e) {
            return new ResponseEntity<>(FAIL_DEFAULT_RES, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity commentLikes(@PathVariable final int commentIdx) {
        try{
            return new ResponseEntity(HttpStatus.OK);
        }catch (Exception e) {
            return new ResponseEntity<>(FAIL_DEFAULT_RES, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity updateComment(@PathVariable final int commentIdx) {
        try{
            return new ResponseEntity(HttpStatus.OK);
        }catch (Exception e) {
            return new ResponseEntity<>(FAIL_DEFAULT_RES, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity deleteComment(@PathVariable final int commentIdx) {
        try{
            return new ResponseEntity(HttpStatus.OK);
        }catch (Exception e) {
            return new ResponseEntity<>(FAIL_DEFAULT_RES, HttpStatus.INTERNAL_SERVER_ERROR);
